    ...
    try:
        ...
        if not os.path.exists(csv_path):
            with open(csv_path, "w", newline="") as csvFile:
                ...
                writer.writerow(["Enrollment", "Name", "Branch"])  # Add headers

        with open(csv_path, "a", newline="") as csvFile:
            writer = csv.writer(csvFile)
            writer.writerow([Enrollment, Name, Branch])

        res = f"Images saved for Enrollment No: {Enrollment}, Name: {Name}, Branch: {Branch}"
